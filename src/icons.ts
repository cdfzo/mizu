...
export const icons: Icons = {
  ...
  'bun-lock': ['bun.lockb'],
  c: ['/c', '*.c'],
  calendar: ['/calendar', '/calendars', '/date', '/dates'],
  carbon: ['*.carbon'],
  cargo: ['cargo.toml'],
  ...
  core: ['/core', '/cores', '/kernel', '/kernels'],
  cpp: [
    '/c++',
    '/cc',
    '/cp',
  ...
  gitpod: ['.gitpod.yml'],
  global: ['/g11n', '/global', '/globalisation', '/globalization', '/globals'],
  ...
  icon: ['/i', '/icns', '/ico', '/icon', '/icons', '/icos', '/svg', '/svgs'],
  idris: ['*.ibc', '*.idr'],
  illustrator: ['*.ai'],
  image: [
    '/_image',
  ...
  lock: ['*.enc', '*.lock', 'security', 'security.md', 'security.txt'],
  log: [
    '/_logs',
    '/changelog',
    '/changelogs',
  ...
  model: ['/class', '/classes', '/model', '/models', '/schema', '/schemas'],
  ...
  sql: ['*.db', '*.pdb', '*.pgsql', '*.pkb', '*.pks', '*.sql'],
  sqlite: ['*.db3', '*.s3db', '*.sl3', '*.sqlite', '*.sqlite3'],
  src: ['/code', '/main', '/source', '/sources', '/src', '/srcs'],
  stats: [
    '/diagram',
    '/diagrams',
    '/excel',
  ...
  target: ['/target', '/tgt'],
  task: ['/task', '/tasks', '/ticket', '/tickets', '/todo', '/todos'],
  tauri: [
    'tauri.conf.json',
    'tauri.conf.json5',
    'tauri.config.json',
