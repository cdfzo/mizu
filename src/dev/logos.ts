...
export const logos: Icons = {
  ...
  epub: ['*.epub'],
  erlang: ['*.erl', '*.hrl'],
  eslint: ['.eslintrc.(js|cjs|json|yml|yaml)', 'eslint.config.(js|cjs|mjs)'],
  ...
  rubyHelp: ['application_helper.rb', 'rails_helper.rb', 'spec_helper.rb'],
  ...
  rubyRoute: ['routes.rb'],
  rubyServer: ['puma.rb'],
  rubyVersion: ['version.rb', '.ruby-version'],
  rust: ['/.rustup', '/cargo', '/rs', '/rust', '*.rlib', '*.rs'],
  rustLib: ['lib.rs'],
  rustMain: ['main.rs'],
  rustModule: ['mod.rs'],
