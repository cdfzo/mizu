...
export const icons: Icons = {
  ...
  auth: [
    '/(auth|authenticate|devise|oauth|sesh)',
  ...
  config: [
    ...
    '/(setting|local settings|setup)',
    '/.(config|settings)',
    '*.(cfg|cnf|conf|config|ini|options|prefs|properties|props|settings)',
    '(config|setup)',
  ],
  contact: ['/contacts?', '/userdata', '*.(vcard|vcf)'],
  ...
  event: ['/(alert|event|state)s?', '/config_states'],
  example: [
  ...
  star: ['/favicons?', '/starred', 'favicon.(ico|png|svg|webp)'],
