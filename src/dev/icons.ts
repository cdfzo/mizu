...
export const icons: Icons = {
  ...
  javascriptComponent: ['*.component.js'],
  javascriptConfig: ['jsconfig.json'],
  javascriptController: ['*.controller.js'],
  javascriptError: ['*.error.js', '*.exception.js'],
  javascriptFilter: ['*.filter.js'],
  javascriptGuard: ['*.guard.js'],
  javascriptMap: ['*.cjs.map', '*.js.map', '*.mjs.map'],
  javascriptPipe: ['*.pipe.js'],
  javascriptServer: ['*.server.js'],
  javascriptService: ['*.service.js'],
  javascriptStore: ['*.store.js'],
  javascriptTest: [
    '*.cy.js',
    '*.e2e-spec.cjs',
    '*.e2e-spec.js',
  ...
  rubyServer: ['puma.rb'],
  rubyRoutes: ['routes.rb'],
  rubySchema: ['schema.rb', 'seeds.rb'],
  ...
  typescriptComponent: ['*.component.ts'],
  typescriptConfig: [
    'tsconfig.cjs.json',
    'tsconfig.esm.json',
    'tsconfig.json',
  ...
  typescriptController: ['*.controller.ts'],
  typescriptDef: ['*.d.cts', '*.d.mts', '*.d.ts'],
  typescriptError: ['*.error.ts', '*.exception.ts'],
  typescriptFilter: ['*.filter.ts'],
  typescriptGuard: ['*.guard.ts'],
  typescriptPipe: ['*.pipe.ts'],
  typescriptServer: ['*.server.ts'],
  typescriptService: ['*.service.ts'],
  typescriptStore: ['*.store.ts'],
  typescriptTest: [
    '*.cy.ts',
    '*.e2e-spec.cts',
    '*.e2e-spec.mts',
